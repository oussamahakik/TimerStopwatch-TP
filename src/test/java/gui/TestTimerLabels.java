...
class TestTimerLabels extends TestGUIAbstract {
	...
	@Test
	@DisplayName("Timer labels match all timer states")
   ...
   @Test
   @DisplayName("Initial timer button labels")
   void testTimerButtonLabels1() {
	...
	@Test
	@DisplayName("SetTimer button labels")
	...
	@Test
	@DisplayName("Stopwatch labels after mode switch")
	...
	@Test
	@DisplayName("Stopwatch labels while running")
